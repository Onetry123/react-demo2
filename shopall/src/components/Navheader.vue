    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:void(0)" v-if="nickName" @click="logOut" class="navbar-link">Logout</a>
            ...
            <ul>
              ...
              <li class="regi_form_input noMargin">
                ...
                <input
                  ...
                  @keyup.enter="login"
                  class="regi_login_input regi_login_input"
                />
              </li>
            </ul>
          </div>
          <div class="login-wrap">
            <span class="btn-login" @click="login">登 陆</span>
          </div>
        </div>
      </div>
    </div>
